...
export class TurnComponent implements OnInit, OnDestroy {
  ...
  loadPage(page?: number, dontNavigate?: boolean): void {
    ...
    this.turnService
      ...
      .subscribe(
        (res: HttpResponse<ITurn[]>) => this.onSuccess(res.body, res.headers, pageToLoad, !dontNavigate),
        () => this.onError()
      );
  }
  ...
  registerChangeInTurns(): void {
    this.eventSubscriber = this.eventManager.subscribe('turnListModification', () => this.loadPage());
  }
  ...
  protected onSuccess(data: ITurn[] | null, headers: HttpHeaders, page: number, navigate: boolean): void {
